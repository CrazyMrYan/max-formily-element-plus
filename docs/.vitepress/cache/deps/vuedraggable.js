...
var init_sortable_esm = __esm({
  'node_modules/sortablejs/modular/sortable.esm.js'() {
    ...
    nearestEmptyInsertDetectEvent = function nearestEmptyInsertDetectEvent2(
      evt
    ) {
      if (dragEl) {
    ...
    ;(function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === 'object' && typeof module === 'object')
        module.exports = factory(
          (init_vue_runtime_esm_bundler(),
          __toCommonJS(vue_runtime_esm_bundler_exports)),
          (init_sortable_esm(), __toCommonJS(sortable_esm_exports))
        )
                  ...
                  },
                  {
                    startsWith: function startsWith(searchString) {
                      ...
                      return nativeStartsWith
                        ? nativeStartsWith.call(that, search, index2)
                        : that.slice(index2, index2 + search.length) === search
                    },
                  }
                )
              },
                  ...
                  function (REPLACE, nativeReplace, maybeCallNative, reason) {
                    ...
                    return [
                      ...
                      function replace(searchValue, replaceValue) {
                        ...
                        var replacer =
                          searchValue == void 0 ? void 0 : searchValue[REPLACE]
                        return replacer !== void 0
            ...
            '9ed3':
              ...
              function (module2, exports2, __webpack_require__) {
                ...
                var IteratorPrototype =
                  __webpack_require__('ae93').IteratorPrototype
                var create = __webpack_require__('7c73')
                var createPropertyDescriptor = __webpack_require__('5c6c')
                var setToStringTag = __webpack_require__('d44e')
                var Iterators = __webpack_require__('3f8c')
              ...
              function (module2, exports2, __webpack_require__) {
                ...
                var createMethod = function (IS_RIGHT) {
                  return function (that, callbackfn, argumentsLength, memo) {
                    ...
                    for (
                      ;
                      IS_RIGHT ? index2 >= 0 : length > index2;
                      index2 += i
                    )
                      if (index2 in self2) {
            ...
            fb15:
              ...
              function (module2, __webpack_exports__, __webpack_require__) {
                ...
                function createSortableOption(_ref6) {
                  ...
                  var draggable = '[data-draggable]'.concat(
                    options.draggable || ''
                  )
                  return _objectSpread22(
                ...
                var getHtmlElementFromNode = function getHtmlElementFromNode2(
                  _ref
                ) {
                  var el = _ref.el
                  return el
                ...
                var componentStructure_ComponentStructure = (function () {
                  function ComponentStructure(_ref2) {
                    ...
                    this.children = [].concat(
                      _toConsumableArray2(header),
                      _toConsumableArray2(defaultNodes),
                      _toConsumableArray2(footer)
                    )
                  ...
                  _createClass(ComponentStructure, [
                    ...
                    },
                    {
                      ...
                      value: function getVmIndexFromDomIndex(
                        domIndex,
                        element
                      ) {
                        var defaultNodes = this.defaultNodes
                        ...
                        var indexFirstDomListElement = _toConsumableArray2(
                          domChildren
                        ).findIndex(function (element2) {
                ...
                function computeNodes(_ref) {
                  ...
                  var defaultNodes = normalizedList.flatMap(function (
                    ...
                    return item({
                      ...
                      node.props = _objectSpread22(
                        _objectSpread22({}, node.props || {}),
                        {},
                        {
                          'data-draggable': true,
                        }
                ...
                var emits = ['update:modelValue', 'change'].concat(
                  _toConsumableArray2(
                    []
                      .concat(
                        _toConsumableArray2(events.manageAndEmit),
                        _toConsumableArray2(events.emit)
                      )
                      .map(function (evt) {
                ...
                var draggableComponent = Object(
                  ...
                  methods: {
                    getUnderlyingVm: function getUnderlyingVm(domElement) {
                      return (
                        this.componentStructure.getUnderlyingVm(domElement) ||
                        null
                      )
                    },
                    getUnderlyingPotencialDraggableComponent:
                      function getUnderlyingPotencialDraggableComponent(
                        htmElement
                      ) {
                    ...
                    spliceList: function spliceList() {
                      ...
                      var spliceList2 = function spliceList3(list) {
                        return list.splice.apply(
                          list,
                          _toConsumableArray2(_arguments)
                        )
                      }
                    ...
                    computeFutureIndex: function computeFutureIndex(
                      ...
                      var domChildren = _toConsumableArray2(
                        evt.to.children
                      ).filter(function (el) {
                      ...
                      var draggedInList =
                        domChildren.indexOf(draggingElement) !== -1
                    ...
                    onDragMove: function onDragMove(evt, originalEvent) {
                      ...
                      var relatedContext =
                        this.getRelatedContextFromMoveEvent(evt)
                      var futureIndex = this.computeFutureIndex(
                        relatedContext,
                        evt
                      )
                      var draggedContext = _objectSpread22(
                        _objectSpread22({}, this.context),
                        {},
                        {
                          futureIndex,
                        }
                      )
                      var sendEvent = _objectSpread22(
                        _objectSpread22({}, evt),
                        {},
                        {
                          relatedContext,
                ...
                $(
                  ...
                  },
                  {
                    slice: function slice(start, end) {
                      ...
                      result = new (
                        Constructor === void 0 ? Array : Constructor
                      )(max(fin - k, 0))
                      for (n = 0; k < fin; k++, n++)
