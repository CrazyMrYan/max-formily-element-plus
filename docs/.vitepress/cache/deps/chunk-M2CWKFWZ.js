import { Tracker, batch, isObservable } from './chunk-BXC2GHWD.js'
import {
  getCurrentInstance,
...
var useObserver = function (options) {
  if (isVue3) {
    ...
    var vmUpdate_1 = function () {
      var _a
      ;(_a = vm_1 === null || vm_1 === void 0 ? void 0 : vm_1.proxy) === null ||
      _a === void 0
        ? void 0
        : _a.$forceUpdate()
    }
    ...
    Object.defineProperty(vm_1, 'effect', {
      ...
      set: function (newValue) {
        ...
        var update = function () {
          var refn = null
          tracker_1 === null || tracker_1 === void 0
            ? void 0
            : tracker_1.track(function () {
...
var observer2 = function (opts, options) {
  var name =
    ...
    opts.name ||
    'ObservableComponent'
  return __assign2(__assign2({ name }, opts), {
...
export { isVue2, collectData, useObserver, observer3 as observer }
//# sourceMappingURL=chunk-M2CWKFWZ.js.map
