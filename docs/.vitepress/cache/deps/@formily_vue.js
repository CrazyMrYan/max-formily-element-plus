...
import { isVue2, observer } from './chunk-M2CWKFWZ.js'
import {
  Path,
  each,
  instOf,
...
var compile = function (source, scope) {
  ...
  var compile2 = function (source2) {
    if (isStr(source2)) {
      ...
      if (isNoNeedCompileObject(source2)) return source2
...
var getUserReactions = function (schema, options) {
  ...
  return reactions.map(function (unCompiled) {
    return function (field) {
      ...
      var when = reaction2.when,
        fulfill = reaction2.fulfill,
        otherwise = reaction2.otherwise,
        target = reaction2.target,
        effects = reaction2.effects
      var run = function () {
        ...
        var runner =
          request === null || request === void 0 ? void 0 : request.run
        setSchemaFieldState({
          field,
          target,
          request,
        ...
        return buf.concat({
          ...
          fulfill: {
            schema: SpecificationV1Polyfill(
              __assign2({ version: '1.0' }, item.schema)
            ),
          },
          otherwise: {
            schema: SpecificationV1Polyfill(
              __assign2({ version: '1.0' }, item.otherwise)
            ),
          },
        })
...
var registerVoidComponents = function (components) {
  VOID_COMPONENTS.push.apply(
    VOID_COMPONENTS,
    __spreadArray([], __read2(components), false)
  )
}
  ...
  (function () {
    function Schema2(json, parent) {
      ...
      this.findDefinitions = function (ref2) {
        if (!ref2 || !_this.root || !isStr(ref2)) return
        if (ref2.indexOf('#/') !== 0) return
      ...
      this.mapPatternProperties = function (callback) {
        return Schema2.getOrderProperties(_this, 'patternProperties').map(
          function (_a, index) {
            var schema = _a.schema,
              key = _a.key
            return callback(schema, key, index)
      ...
      this.reduceProperties = function (callback, predicate) {
        ...
        Schema2.getOrderProperties(_this, 'properties').forEach(function (
          _a,
          index
        ) {
          var schema = _a.schema,
      ...
      this.reducePatternProperties = function (callback, predicate) {
        var results = predicate
        Schema2.getOrderProperties(_this, 'patternProperties').forEach(
          function (_a, index) {
            var schema = _a.schema,
              key = _a.key
            results = callback(results, schema, key, index)
      ...
      this.fromJSON = function (json2) {
        if (!json2) return _this
        if (Schema2.isSchemaInstance(json2)) return json2
...
var getChildNodesWithFragments = function getChildNodesWithFragments2(node) {
  if (!getChildNodes) {
    var _childNodesDescriptor = Object.getOwnPropertyDescriptor(
      Node.prototype,
      'childNodes'
    )
  ...
  return (_Array$prototype = Array.prototype).concat.apply(
    ...
    children.map(function (childNode) {
      return isFrag(childNode)
        ? getFragmentLeafNodes2(childNode.frag)
        : childNode
    })
  )
}
    ...
    if (key === 'on' || key === 'nativeOn') {
      if (value) {
        each(value, function (func, name) {
          var eventName = 'on'
            .concat(key === 'on' ? name[0].toUpperCase() : name[0])
            .concat(name.slice(1))
  ...
  if (isVue2) {
    ...
    if (Object.keys(scopedSlots).length > 0) {
      if (!newData.scopedSlots) {
        ...
        newData.scopedSlots = __assign4(
          __assign4({}, newData.scopedSlots),
          scopedSlots
        )
      }
    }
...
var useParentForm = function () {
  ...
  var findObjectParent = function (field2) {
    if (!field2) return form.value
    if (isObjectField(field2)) return field2
    return findObjectParent(
      field2 === null || field2 === void 0 ? void 0 : field2.parent
    )
  }
...
var FormConsumer_default = observer(
  defineComponent({
    name: 'FormConsumer',
    inheritAttrs: false,
    setup: function (props, _a) {
        ...
        setup: function (props, _a) {
          ...
          return function () {
            var newAttrs = fieldRef.value
              ? transform(__assign5({}, attrs), fieldRef.value)
              : __assign5({}, attrs)
            return h_default(
              target,
              {
...
var resolveComponent = function (render2, extra) {
  ...
  if (typeof extra === 'string') {
    return function () {
      return __spreadArray3(
        __spreadArray3([], __read4(render2()), false),
        [extra],
        false
      )
    }
  ...
  if (
    extra.length > 1 ||
    ((_a = extra === null || extra === void 0 ? void 0 : extra.render) ===
      null || _a === void 0
      ? void 0
      : _a.length) > 1
  ) {
...
var mergeSlots = function (field, slots, content) {
  ...
  var patchSlot = function (slotName) {
    return function () {
      ...
      return (_b =
        (_a2 = slots[slotName]) === null || _a2 === void 0
          ? void 0
          : _a2.call(
              slots,
              __assign6({ field, form: field.form }, originArgs[0])
            )) !== null && _b !== void 0
        ? _b
        : []
    }
  ...
  if (content && typeof content === 'object' && !isVueOptions(content)) {
    Object.keys(content).forEach(function (key) {
      ...
      var slot =
        (_a2 = patchedSlots[key]) !== null && _a2 !== void 0
          ? _a2
          : function () {
              return []
            }
  ...
  patchedSlots['default'] = resolveComponent(
    (_a = patchedSlots['default']) !== null && _a !== void 0
      ? _a
      : function () {
          return []
        },
    ...
    var createField = function () {
      ...
      return (_b =
        (_a2 =
          ...
          null || _a2 === void 0
          ? void 0
          : _a2['create'.concat(props.fieldType)]) === null || _b === void 0
        ? void 0
        : _b.call(
            _a2,
            __assign6(__assign6({}, props.fieldProps), {
              basePath:
                (_d =
                  (_c = props.fieldProps) === null || _c === void 0
                    ? void 0
                    : _c.basePath) !== null && _d !== void 0
                  ? _d
                  : (_e = parentRef.value) === null || _e === void 0
                  ? void 0
                  : _e.address,
            })
          )
    ...
    return function () {
      ...
      var renderDecorator = function (childNodes) {
        ...
        var componentData = {
          ...
          style:
            componentAttrs === null || componentAttrs === void 0
              ? void 0
              : componentAttrs.style,
          class:
            componentAttrs === null || componentAttrs === void 0
              ? void 0
              : componentAttrs.class,
          on: events,
        }
      ...
      var renderComponent = function () {
        ...
        if (!field.componentType)
          return wrapFragment(
            (_a3 =
              mergedSlots === null || mergedSlots === void 0
                ? void 0
                : mergedSlots.default) === null || _a3 === void 0
              ? void 0
              : _a3.call(mergedSlots)
          )
        var component =
          (_b = Path.getIn(
            options === null || options === void 0
        ...
        events.change = function () {
          ...
          originChange === null || originChange === void 0
            ...
            : originChange.apply(
                void 0,
                __spreadArray3([], __read4(args), false)
              )
        }
        ...
        events.blur = function () {
          ...
          originBlur === null || originBlur === void 0
            ? void 0
            : originBlur.apply(void 0, __spreadArray3([], __read4(args), false))
        }
        var componentData = {
          attrs: __assign6(
            __assign6(
            ...
            { value: !isVoidField(field) ? field.value : void 0 }
          ),
          style:
...
if (isVue2) {
  ArrayField = {
    ...
    render: function (h2, context) {
      ...
      var componentData = __assign7(__assign7({}, context.data), {
        props: {
          fieldType: 'ArrayField',
          fieldProps: __assign7(
            __assign7(__assign7({}, attrs), props),
...
if (isVue2) {
  ObjectField = {
    ...
    render: function (h2, context) {
      var props = context.props
      var attrs = context.data.attrs
      var componentData = __assign8(__assign8({}, context.data), {
        props: {
          fieldType: 'ObjectField',
          fieldProps: __assign8(
            __assign8(__assign8({}, attrs), props),
            getRawComponent(props)
          ),
        },
      })
...
if (isVue2) {
  VoidField = {
    ...
    render: function (h2, context) {
      var props = context.props
      var attrs = context.data.attrs
      var componentData = __assign9(__assign9({}, context.data), {
        props: {
          fieldType: 'VoidField',
          fieldProps: __assign9(
            __assign9(__assign9({}, attrs), props),
            getRawComponent(props)
          ),
        },
      })
...
if (isVue2) {
  Field = {
    ...
    render: function (h2, context) {
      var props = context.props
      var attrs = context.data.attrs
      var componentData = __assign10(__assign10({}, context.data), {
        props: {
          fieldType: 'Field',
          fieldProps: __assign10(
            __assign10(__assign10({}, attrs), props),
            getRawComponent(props)
          ),
        },
      })
...
var resolveEmptySlot = function (slots) {
  return Object.keys(slots).length
    ? compatibleCreateElement('div', { style: 'display:contents;' }, slots)
    : void 0
}
var RecursionField = {
  name: 'RecursionField',
  ...
  setup: function (props) {
    ...
    var getPropsFromSchema = function (schema) {
      var _a
      return (_a =
        schema === null || schema === void 0 ? void 0 : schema.toFieldProps) ===
        null || _a === void 0
        ? void 0
        : _a.call(
            schema,
            __assign11(__assign11({}, optionsRef.value), {
              get scope() {
    ...
    var getBasePath = function () {
      ...
      if (props.onlyRenderProperties) {
        return (_a = props.basePath) !== null && _a !== void 0
          ? _a
          : (_b =
          ...
          ? void 0
          : _b.address.concat(props.name)
      }
      return (_c = props.basePath) !== null && _c !== void 0
        ? _c
        : (_d =
            parentRef === null || parentRef === void 0
              ? void 0
              : parentRef.value) === null || _d === void 0
        ? void 0
        : _d.address
    }
    ...
    return function () {
      ...
      var generateSlotsByProperties = function (scoped) {
        ...
        properties.forEach(function (_a, index) {
          ...
          setRender(
            (_b = schema['x-slot']) !== null && _b !== void 0 ? _b : 'default',
            function (field) {
              var _a2
              return compatibleCreateElement(
                RecursionField,
      ...
      var render2 = function () {
        ...
        if (fieldSchemaRef.value.type === 'object') {
          ...
          return compatibleCreateElement(
            ObjectField_default,
            {
              attrs: __assign11(__assign11({}, fieldProps), {
                name: props.name,
                basePath,
              }),
            },
    ...
    setup: function (props, _a) {
      ...
      var schemaRef = computed(function () {
        return Schema.isSchemaInstance(props.schema)
          ? props.schema
          : new Schema(__assign12({ type: 'object' }, props.schema))
      })
      var scopeRef = computed(function () {
        return lazyMerge(options.scope, props.scope)
      })
      var optionsRef = computed(function () {
        return __assign12(__assign12({}, options), {
          components: __assign12(
            __assign12({}, options.components),
            props.components
          ),
        })
      })
        ...
        return compatibleCreateElement(
          ...
          {},
          {
            default: function () {
              ...
              children.push(
                compatibleCreateElement(
                  RecursionField_default,
                  {
                    attrs: __assign12(__assign12({}, props), {
