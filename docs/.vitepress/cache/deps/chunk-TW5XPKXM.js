          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                ...
                callback(
                  value,
                  __assign(__assign({}, rules), { message }),
                  context_,
                  function (message2, scope) {
                    var _a2
                    return (_a2 = render(
                      {
                        type: 'error',
...
;(function (LifeCycleTypes2) {
  ...
  LifeCycleTypes2['ON_FORM_SUBMIT_VALIDATE_SUCCESS'] =
    'onFormSubmitValidateSuccess'
  LifeCycleTypes2['ON_FORM_SUBMIT_VALIDATE_FAILED'] =
  ...
  LifeCycleTypes2['ON_FIELD_SUBMIT_VALIDATE_START'] =
    'onFieldSubmitValidateStart'
  LifeCycleTypes2['ON_FIELD_SUBMIT_VALIDATE_SUCCESS'] =
    'onFieldSubmitValidateSuccess'
  LifeCycleTypes2['ON_FIELD_SUBMIT_VALIDATE_FAILED'] =
      ...
      if (searched_1.length) {
        field.feedbacks = field.feedbacks.reduce(function (buf, item) {
          ...
          if (searched_1.includes(item)) {
            if (
              (_a2 = feedback.messages) === null || _a2 === void 0
                ? void 0
                : _a2.length
            ) {
...
var spliceArrayState = function (field, props) {
  var _a = __assign3({ startIndex: 0, deleteCount: 0, insertCount: 0 }, props),
  ...
  var isAfterNode = function (identifier) {
    ...
    var number =
      (_a2 = afterStr.match(NumberIndexReg)) === null || _a2 === void 0
        ? void 0
        : _a2[1]
...
var exchangeArrayState = function (field, props) {
  var _a = __assign3({ fromIndex: 0, toIndex: 0 }, props),
...
var getArrayParent = function (field, index) {
  ...
  if (index > -1) {
    ...
    while (parent_2) {
      if (isArrayField(parent_2)) return parent_2
      if (parent_2 === field.form) return
  ...
  (function () {
    function BaseField2() {
      ...
      this.invoke = function (name) {
        ...
        return (_b = (_a = _this.actions)[name]) === null || _b === void 0
          ? void 0
          : _b.call.apply(_b, __spreadArray2([_a], __read2(args), false))
      }
    }
    ...
    Object.defineProperty(BaseField2.prototype, 'index', {
      get: function () {
        var _a
        return (_a = this.indexes[this.indexes.length - 1]) !== null &&
          _a !== void 0
          ? _a
          : -1
      },
    ...
    Object.defineProperty(BaseField2.prototype, 'record', {
      get: function () {
        ...
        if (array) {
          return (_a = array.value) === null || _a === void 0
            ? void 0
            : _a[index]
        }
    ...
    function Field2(address, props, form, designable) {
      ...
      _this.setValue = function (value) {
        ...
        if (!_this.initialized) {
          ...
          if (
            !allowAssignDefaultValue(_this.value, value) &&
            !_this.designable
          ) {
            return
          }
      ...
      _this.setInitialValue = function (initialValue) {
        ...
        if (!_this.initialized) {
          if (
            !allowAssignDefaultValue(_this.initialValue, initialValue) &&
            !_this.designable
          ) {
            return
          }
            ...
            switch (_a.label) {
              case 0:
                isHTMLInputEventFromSelf = function (args2) {
                  var _a2, _b
                  return isHTMLInputEvent(args2[0]) &&
                    'currentTarget' in args2[0]
                    ? ((_a2 = args2[0]) === null || _a2 === void 0
                        ? void 0
                        : _a2.target) ===
                        ((_b = args2[0]) === null || _b === void 0
                          ? void 0
                          : _b.currentTarget)
                    : true
                }
                getValues = function (args2) {
                  ...
                  if (
                    ...
                    if (!isHTMLInputEvent(args2[0])) return args2
                  }
          ...
          if (isFn(callback)) {
            callback
              .apply(
                ...
                __spreadArray3(
                  [payload, ctx],
                  __read3(GlobalState.context),
                  false
                )
              )
              .apply(void 0, __spreadArray3([], __read3(args), false))
          }
        })
      )
    } else {
      ...
      _this.push = function () {
        ...
        return action(function () {
          ...
          ;(_a = _this.value).push.apply(
            _a,
            __spreadArray4([], __read4(items), false)
          )
      ...
      _this.insert = function (index) {
        ...
        return action(function () {
          ...
          ;(_a = _this.value).splice.apply(
            _a,
            __spreadArray4([index, 0], __read4(items), false)
          )
          return _this.onInput(_this.value)
        })
      }
      ...
      this.createArrayField = function (props2) {
        ...
        if (!_this.fields[identifier] || _this.props.designable) {
          batch(function () {
            new ArrayField(
              address,
              __assign4(__assign4({}, props2), {
                value: isArr(props2.value) ? props2.value : [],
              }),
              _this,
        ...
        if (!_this.fields[identifier] || _this.props.designable) {
          batch(function () {
            new ObjectField(
              address,
              __assign4(__assign4({}, props2), {
                value: isObj(props2.value) ? props2.value : {},
              }),
              _this,
              _this.props.designable
            )
            ...
            return messages.concat(
              field
                ...
                .map(function (feedback) {
                  return __assign4(__assign4({}, feedback), {
...
//# sourceMappingURL=chunk-TW5XPKXM.js.map
