import { batch, define, observable, reaction } from './chunk-BXC2GHWD.js'
  ...
  (function () {
    ...
    Object.defineProperty(Grid2.prototype, 'columns', {
      get: function () {
        ...
        var strictMaxWidthColumns = Math.round(
          this.width / (this.maxWidth + this.columnGap)
        )
        var looseMaxWidthColumns = Math.min(
          originTotalColumns,
        ...
        var strictMinWidthColumns = Math.round(
          this.width / (this.minWidth + this.columnGap)
        )
        var looseMinWidthColumns = Math.min(
          originTotalColumns,
