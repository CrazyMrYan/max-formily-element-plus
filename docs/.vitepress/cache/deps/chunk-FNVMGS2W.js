...
function pascalCase(input, options) {
  ...
  return noCase(
    input,
    __assign2({ delimiter: '', transform: pascalCaseTransform }, options)
  )
}

// node_modules/@formily/shared/node_modules/camel-case/dist.es2015/index.js
...
function camelCase(input, options) {
  ...
  return pascalCase(
    input,
    __assign2({ transform: camelCaseTransform }, options)
  )
}
...
var Matcher =
  ...
  (function () {
    ...
    Matcher2.prototype.shot = function () {
      var _a
      if (
        ((_a = this.record) === null || _a === void 0 ? void 0 : _a.score) >= 0
      ) {
        this.record.score++
      }
    }
    ...
    Matcher2.matchSegments = function (source, target, record) {
      ...
      var match = function (pos) {
        ...
        if (
          (record === null || record === void 0 ? void 0 : record.score) >= 0
        ) {
          record.score++
        }
...
var setIn = function (segments, source, value) {
  for (var i = 0; i < segments.length; i++) {
    ...
    var rules = getDestructor(index)
    if (!rules) {
      if (!isValid3(source) || !isAssignable(source)) return
...
var existIn = function (segments, source, start) {
  ...
  for (var i = start; i < segments.length; i++) {
    ...
    if (!rules) {
      ...
      if (!isValid3(source) || !isAssignable(source)) return false
      source = source[index]
      if (!isObj2(source)) {
        return false
      }
  ...
  (function () {
    function Path2(input, base) {
      ...
      this.concat = function () {
        ...
        var path = new Path2('')
        path.segments = (_a2 = _this.segments).concat.apply(
          _a2,
          __spreadArray(
            [],
            __read(
      ...
      this.includes = function (pattern) {
        var _a2 = Path2.parse(pattern),
          entire2 = _a2.entire,
          segments2 = _a2.segments,
          isMatchPattern2 = _a2.isMatchPattern
        ...
        if (isMatchPattern2) {
          throw new Error(
            ''.concat(_this.entire, ' cannot be used to match ').concat(entire2)
          )
        }
        if (segments2.length > _this.segments.length) return cacheWith(false)
        ...
        if (path.isMatchPattern) {
          ...
          if (_this.isMatchPattern) {
            if (_this.isRegExp) {
              try {
                return (_b =
                  (_a2 = _this['entire']) === null || _a2 === void 0
                    ? void 0
                    : _a2['test']) === null || _b === void 0
                  ? void 0
                  : _b.call(_a2, path.entire)
              } finally {
...
var applyMiddleware = function (payload, fns) {
  ...
  var compose = function (payload2, fns2) {
    ...
    return Promise.resolve(
      fns2[0](payload2, function (payload3) {
        return compose(
          payload3 !== null && payload3 !== void 0 ? payload3 : prevPayload,
          fns2.slice(1)
        )
      })
    )
...
function cloneUnlessOtherwiseSpecified(value, options) {
  ...
  if (
    options.clone !== false &&
    ((_a = options.isMergeableObject) === null || _a === void 0
      ? void 0
      : _a.call(options, value))
  ) {
...
function mergeObject(target, source, options) {
  ...
  getKeys(source).forEach(function (key) {
    ...
    if (isEmpty(target[key])) {
      ...
      propertyIsOnObject(target, key) && // @ts-ignore
...
var lazyMerge = function (target) {
  ...
  var _lazyMerge = function (target2, source) {
    if (!isValid(source)) return target2
    if (!isValid(target2)) return source
...
//# sourceMappingURL=chunk-FNVMGS2W.js.map
