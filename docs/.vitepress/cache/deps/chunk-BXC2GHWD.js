...
var releaseBindingReactions = function (reaction2) {
  var _a2
  ;(_a2 = reaction2._reactionsSet) === null || _a2 === void 0
    ? void 0
    : _a2.forEach(function (reactionsMap) {
...
var suspendComputedReactions = function (current) {
  var _a2
  ;(_a2 = current._computesSet) === null || _a2 === void 0
    ? void 0
    : _a2.forEach(function (reaction2) {
...
var isObservable = function (target) {
  return (
    ProxyRaw.has(target) ||
    !!(target === null || target === void 0 ? void 0 : target[ObModelSymbol])
  )
}
...
var wellKnownSymbols = new Set(
  Object.getOwnPropertyNames(Symbol).reduce(function (buf, key) {
...
function patchIterator(target, key, iterator, isEntries) {
  ...
  iterator.next = function () {
    var _a2 = originalNext.call(iterator),
      done = _a2.done,
      value = _a2.value
    if (!done) {
      if (isEntries) {
...
var instrumentations =
  ((_a = {
    ...
    forEach: function (cb) {
      ...
      return (_a2 = proto.forEach).call.apply(
        _a2,
...
var collectionHandlers = {
  get: function (target, key, receiver) {
    target = hasOwnProperty2.call(instrumentations, key)
      ? instrumentations
      : target
...
var createObservable = function (target, key, value, shallow2) {
  ...
  if (shallow2) return createShallowProxy(value)
...
var computed = createAnnotation(function (_a2) {
  ...
  function compute() {
    var _a3
    store.value =
      (_a3 = descriptor.get) === null || _a3 === void 0
        ? void 0
        : _a3.call(context)
  }
  function reaction2() {
  ...
  function set(value2) {
    ...
    try {
      batchStart()
      ;(_a3 = descriptor.set) === null || _a3 === void 0
        ? void 0
        : _a3.call(context, value2)
    } finally {
      batchEnd()
    }
  }
